(uiop/package:define-package #:pira/waf-regional (:use)
                             (:export #:awswaf-regional-20161128 #:action
                              #:activated-rule #:activated-rules
                              #:associate-web-acl #:byte-match-set
                              #:byte-match-set-summaries
                              ...
                              #:delete-xss-match-set #:disassociate-web-acl
                              #:error-reason #:excluded-rule #:excluded-rules
                              #:field-to-match #:geo-match-constraint
                              ...
                              #:httprequest #:httpversion #:header-name
                              #:header-value #:ipset #:ipset-descriptor
                              ...
                              #:resource-name #:resource-type #:rule
                              #:rule-group #:rule-group-summaries
...
(smithy/sdk/shapes:define-output get-web-aclfor-resource-response
                                 common-lisp:nil
                                 ((web-aclsummary :target-type web-aclsummary
                                   :member-name "WebACLSummary"))
