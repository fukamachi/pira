(uiop/package:define-package #:pira/cloudwatch-events (:use)
                             (:export #:awsevents #:account-id #:action
                              ...
                              #:api-destination-state #:archive #:archive-arn
                              #:archive-description #:archive-name
                              #:archive-response-list #:archive-state
                              #:archive-state-reason #:arn #:assign-public-ip
                              ...
                              #:rule-state #:run-command-parameters
                              #:run-command-target #:run-command-target-key
...
(smithy/sdk/shapes:define-input create-archive-request common-lisp:nil
                                ((archive-name :target-type archive-name
                                  :required common-lisp:t :member-name
                                  "ArchiveName")
                                 (event-source-arn :target-type arn :required
                                  common-lisp:t :member-name "EventSourceArn")
