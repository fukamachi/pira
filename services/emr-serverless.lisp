...
(smithy/sdk/shapes:define-structure cancel-job-run-request common-lisp:nil
                                    ((application-id :target-type
                                      application-id :required common-lisp:t
                                      :member-name "applicationId")
...
(smithy/sdk/shapes:define-structure get-dashboard-for-job-run-request
                                    common-lisp:nil
                                    ((application-id :target-type
                                      application-id :required common-lisp:t
                                      :member-name "applicationId")
                                     ...
                                     (access-system-profile-logs :target-type
                                      smithy/sdk/smithy-types:boolean
                                      :member-name "accessSystemProfileLogs"
                                      :http-query "accessSystemProfileLogs"))
                                    (:shape-name
...
(smithy/sdk/shapes:define-structure get-job-run-request common-lisp:nil
                                    ((application-id :target-type
                                      application-id :required common-lisp:t
                                      :member-name "applicationId")
                                     (job-run-id :target-type job-run-id
...
(smithy/sdk/shapes:define-structure list-job-runs-request common-lisp:nil
                                    ((application-id :target-type
                                      application-id :required common-lisp:t
                                      :member-name "applicationId")
                                     (next-token :target-type next-token
                                     ...
                                     (created-at-before :target-type date
                                      :member-name "createdAtBefore"
                                      :http-query "createdAtBefore")
...
(smithy/sdk/shapes:define-structure start-job-run-request common-lisp:nil
                                    ((application-id :target-type
                                      application-id :required common-lisp:t
                                      :member-name "applicationId")
                                     (client-token :target-type client-token
