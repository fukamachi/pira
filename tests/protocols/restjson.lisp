...
(smithy/sdk/shapes:define-structure malformed-length-query-string-input
                                    common-lisp:nil
                                    ((string :target-type length-string
                                      :member-name "string" :http-query
                                      "string"))
                                    (:shape-name
...
(smithy/sdk/shapes:define-structure malformed-required-input common-lisp:nil
                                    ((string :target-type
                                     ...
                                     (string-in-query :target-type
                                      ...
                                      "stringInQuery" :http-query
                                      "stringInQuery")
                                     (string-in-header :target-type
                                      smithy/sdk/smithy-types:string :required
                                      common-lisp:t :member-name
                                      "stringInHeader" :http-header
                                      "string-in-headers"))
