(uiop/package:define-package #:pira/tests/protocols/query (:use)
                             (:export #:aws-query #:complex-map
                              ...
                              #:flattened-xml-map #:flattened-xml-map-output
                              #:flattened-xml-map-with-xml-name
                              #:flattened-xml-map-with-xml-name-output
                              #:flattened-xml-map-with-xml-name-output-map
                              ...
                              #:map-of-lists #:map-with-xml-name
                              #:nested-struct-with-list
                              #:nested-struct-with-map #:nested-structures
                              #:nested-structures-input
                              ...
                              #:query-lists #:query-lists-input #:query-maps
                              #:query-maps-input #:query-timestamps
                              #:query-timestamps-input #:recursive-xml-shapes
                              ...
                              #:xml-empty-lists #:xml-empty-maps #:xml-enums
                              #:xml-enums-output #:xml-int-enums
                              #:xml-int-enums-output #:xml-lists
                              #:xml-lists-output #:xml-maps #:xml-maps-output
                              #:xml-maps-output-map #:xml-maps-xml-name
                              #:xml-maps-xml-name-output
                              #:xml-maps-xml-name-output-map
                              #:xml-namespace-nested #:xml-namespaced-list
                              #:xml-namespaces #:xml-namespaces-output
                              #:xml-timestamps #:xml-timestamps-output))
(common-lisp:in-package #:pira/tests/protocols/query)

(smithy/sdk/service:define-service aws-query :shape-name "AwsQuery" :version
                                   "2020-01-08" :title
                                   "Sample Query Protocol Service" :operations
                                   '(datetime-offsets
                                     empty-input-and-empty-output
                                     endpoint-operation
                                     endpoint-with-host-label-operation
                                     ...
                                     host-with-path-operation
                                     ignores-wrapping-xml-name
                                     nested-structures no-input-and-no-output
                                     no-input-and-output
                                     put-with-content-encoding
                                     query-idempotency-token-auto-fill
                                     query-lists query-maps query-timestamps
                                     recursive-xml-shapes simple-input-params
                                     simple-scalar-xml-properties xml-blobs
                                     xml-empty-blobs xml-empty-lists
                                     xml-empty-maps xml-enums xml-int-enums
                                     xml-lists xml-maps xml-maps-xml-name
                                     xml-namespaces xml-timestamps)
                                   :xml-namespace
...
(smithy/sdk/shapes:define-map complex-map :key smithy/sdk/smithy-types:string
                              :value greeting-struct)
...
(smithy/sdk/shapes:define-structure flattened-xml-map-output common-lisp:nil
                                    ((my-map :target-type foo-enum-map
                                      :member-name "myMap" :xml-flattened
                                      common-lisp:t))
                                    (:shape-name "FlattenedXmlMapOutput"))

(smithy/sdk/shapes:define-structure flattened-xml-map-with-xml-name-output
                                    common-lisp:nil
                                    ((my-map :target-type
                                      flattened-xml-map-with-xml-name-output-map
...
(smithy/sdk/shapes:define-map flattened-xml-map-with-xml-name-output-map :key
...
(smithy/sdk/shapes:define-map map-of-lists :key smithy/sdk/smithy-types:string
                              :value string-list)

(smithy/sdk/shapes:define-map map-with-xml-name :key
                              (smithy/sdk/smithy-types:string :xml-name "K")
                              :value
                              (smithy/sdk/smithy-types:string :xml-name "V"))
...
(smithy/sdk/shapes:define-structure nested-struct-with-map common-lisp:nil
                                    ((map-arg :target-type string-map
                                      :member-name "MapArg"))
                                    (:shape-name "NestedStructWithMap"))
...
(smithy/sdk/shapes:define-input no-input-and-output-input common-lisp:nil
                                common-lisp:nil
                                (:shape-name "NoInputAndOutputInput"))
...
(smithy/sdk/shapes:define-structure query-lists-input common-lisp:nil
                                    ((list-arg :target-type string-list
                                     ...
                                     (complex-list-arg :target-type
                                      ...
                                      "ComplexListArg")
                                     (flattened-list-arg :target-type
                                      string-list :member-name
                                      "FlattenedListArg" :xml-flattened
                                      common-lisp:t)
                                     (list-arg-with-xml-name-member
                                      :target-type list-with-xml-name
                                      :member-name "ListArgWithXmlNameMember")
                                     (flattened-list-arg-with-xml-name
                                      :target-type list-with-xml-name
                                      :member-name
                                      "FlattenedListArgWithXmlName" :xml-name
                                      "Hi" :xml-flattened common-lisp:t)
                                     (nested-with-list :target-type
                                      nested-struct-with-list :member-name
                                      "NestedWithList"))
                                    (:shape-name "QueryListsInput"))

(smithy/sdk/shapes:define-structure query-maps-input common-lisp:nil
                                    ((map-arg :target-type string-map
                                      :member-name "MapArg")
                                     (renamed-map-arg :target-type string-map
                                      :member-name "RenamedMapArg" :xml-name
                                      "Foo")
                                     (complex-map-arg :target-type complex-map
                                      :member-name "ComplexMapArg")
                                     (map-with-xml-member-name :target-type
                                      map-with-xml-name :member-name
                                      "MapWithXmlMemberName")
                                     (flattened-map :target-type string-map
                                      :member-name "FlattenedMap"
                                      :xml-flattened common-lisp:t)
                                     (flattened-map-with-xml-name :target-type
                                      map-with-xml-name :member-name
                                      "FlattenedMapWithXmlName" :xml-name "Hi"
                                      :xml-flattened common-lisp:t)
                                     (map-of-lists :target-type map-of-lists
                                      :member-name "MapOfLists")
                                     (nested-struct-with-map :target-type
                                      nested-struct-with-map :member-name
                                      "NestedStructWithMap"))
                                    (:shape-name "QueryMapsInput"))
...
(smithy/sdk/shapes:define-structure simple-input-params-input common-lisp:nil
                                    ((foo :target-type
                                     ...
                                     (foo-enum :target-type foo-enum
                                      :member-name "FooEnum")
                                     (integer-enum :target-type integer-enum
                                      :member-name "IntegerEnum"))
...
(smithy/sdk/shapes:define-structure xml-maps-output common-lisp:nil
                                    ((my-map :target-type xml-maps-output-map
                                      :member-name "myMap"))
                                    (:shape-name "XmlMapsOutput"))

(smithy/sdk/shapes:define-map xml-maps-output-map :key
                              smithy/sdk/smithy-types:string :value
                              greeting-struct)

(smithy/sdk/shapes:define-structure xml-maps-xml-name-output common-lisp:nil
                                    ((my-map :target-type
                                      xml-maps-xml-name-output-map :member-name
                                      "myMap"))
                                    (:shape-name "XmlMapsXmlNameOutput"))

(smithy/sdk/shapes:define-map xml-maps-xml-name-output-map :key
                              (smithy/sdk/smithy-types:string :xml-name
                               "Attribute")
...
(smithy/sdk/operation:define-operation endpoint-operation :shape-name
                                       ...
                                       :request-tests
                                       ((:id "AwsQueryEndpointTrait" :protocol
                                         "aws.protocols#awsQuery" :method
...
(smithy/sdk/operation:define-operation flattened-xml-map :shape-name
                                       ...
                                       common-lisp:null :output
                                       flattened-xml-map-output :errors
                                       common-lisp:nil :response-tests
...
(smithy/sdk/operation:define-operation greeting-with-errors :shape-name
                                       ...
                                       (complex-error custom-code-error
                                        invalid-greeting)
                                       :response-tests
...
(smithy/sdk/operation:define-operation no-input-and-output :shape-name
                                       ...
                                       no-input-and-output-input :output
                                       no-input-and-output-output :errors
                                       common-lisp:nil :request-tests
                                       ((:id "QueryNoInputAndOutput" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
                                       ...
                                       :response-tests
                                       ((:id "QueryNoInputAndOutput" :protocol
                                         "aws.protocols#awsQuery" :code 200
...
(smithy/sdk/operation:define-operation query-lists :shape-name "QueryLists"
                                       ...
                                       ((:id "QueryLists" :protocol
                                        ...
                                        (:id "FlattenedQueryLists" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
...
(smithy/sdk/operation:define-operation query-maps :shape-name "QueryMaps"
                                       :input query-maps-input :output
                                       common-lisp:null :errors common-lisp:nil
                                       :request-tests
                                       ((:id "QuerySimpleQueryMaps" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
                                        ...
                                        (:id "QueryComplexQueryMaps" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
                                        ...
                                        (:id "QueryEmptyQueryMaps" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
                                        ...
                                        (:id "QueryQueryMapOfLists" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
...
(smithy/sdk/operation:define-operation query-timestamps :shape-name
                                       ...
                                       common-lisp:null :errors common-lisp:nil
                                       :request-tests
                                       ((:id "QueryTimestampsInput" :protocol
                                         "aws.protocols#awsQuery" :method
                                         "POST" :uri "/" :headers
                                         (("Content-Type"
                                           . "application/x-www-form-urlencoded"))
...
(smithy/sdk/operation:define-operation recursive-xml-shapes :shape-name
                                       ...
                                       common-lisp:nil :response-tests
                                       ((:id "QueryRecursiveShapes" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-empty-blobs :shape-name
                                       ...
                                       common-lisp:nil :response-tests
                                       ((:id "QueryXmlEmptyBlobs" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-empty-lists :shape-name
                                       ...
                                       common-lisp:nil :response-tests
                                       ((:id "QueryXmlEmptyLists" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-empty-maps :shape-name
                                       "XmlEmptyMaps" :input common-lisp:null
                                       :output xml-maps-output :errors
                                       common-lisp:nil :response-tests
                                       ((:id "QueryXmlEmptyMaps" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-maps :shape-name "XmlMaps" :input
                                       common-lisp:null :output xml-maps-output
                                       :errors common-lisp:nil :response-tests
                                       ((:id "QueryXmlMaps" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-maps-xml-name :shape-name
                                       "XmlMapsXmlName" :input common-lisp:null
                                       :output xml-maps-xml-name-output :errors
                                       common-lisp:nil :response-tests
...
(smithy/sdk/operation:define-operation xml-namespaces :shape-name
                                       ...
                                       common-lisp:nil :response-tests
                                       ((:id "QueryXmlNamespaces" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
...
(smithy/sdk/operation:define-operation xml-timestamps :shape-name
                                       ...
                                       common-lisp:nil :response-tests
                                       ((:id "QueryXmlTimestamps" :protocol
                                         "aws.protocols#awsQuery" :code 200
                                         :headers
                                         (("Content-Type" . "text/xml")) :body
